                ...
                <form @submit.prevent="createApiToken">
                    <div class="lg:grid lg:grid-cols-12 gap-6">
                        <div class="md:col-span-8">
                            <app-input type="text" v-model="createApiTokenForm.name" :error="createApiTokenForm.errors.name" label="Token name" placeholder="Cratespace Mobile App"></app-input>
                        </div>
                            ...
                            <div class="rounded-lg bg-gray-50 px-4 py-5 px-6" v-for="token in tokens" :key="token.id">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center">
                                        <button class="cursor-pointer ml-6 text-sm text-gray-700" @click="manageApiTokenPermissions(token)" v-if="availablePermissions.length > 0">
                                            Permissions
                                        </button>
